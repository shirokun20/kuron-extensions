...
## 🛠️ Requesting an Extension

Want a new extension or source to be added? You can support the development by donating, and we will try to add it here as soon as possible. 

Alternatively, you can also open a new **Issue** in this repository to request a new source!
